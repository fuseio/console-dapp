...
const Navbar = ({ selected = "staking" }: NavbarProps) => {
  return (
    <nav className="h-screen w-1/9 border-r-0.5 border-gray flex flex-col sticky top-0 z-999">
      <a href="/">
        <img src={logo.src} alt="logo" width="60%" className="pt-7 ms-7" />
      </a>
      <div className="mt-16">
        <div
          className={
        ...
        >
          <img
            src={selected === "staking" ? homeGreen.src : home.src}
            alt="home"
        ...
        >
          <img
            src={selected === "safe" ? homeGreen.src : home.src}
            alt="home"
            className="inline align-text-top"
          />
        ...
        >
          <img
            src={selected === "bridge" ? homeGreen.src : home.src}
            alt="home"
            className="inline align-text-top"
          />
