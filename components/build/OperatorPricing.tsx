      ...
      <section className={cn("flex flex-col", classNames?.pricingSection)}>
        ...
        <article className={cn(
          ...
          <Plan
            ...
            price={0}
            features={["Up to 1000 monthly transactions", "50 Edison AI prompts", "10K RPC calls", "10K API calls", "10K Webhook calls"]}
          ...
          <Plan
            ...
            features={["1M transactions", "Up to 1000 Edison AI prompts", "1M RPC calls", "1M API calls", "1M Webhook calls", "Access to all services on Fuse", "Reliable and fast support"]}
          ...
          <Plan
            ...
            features={["Everything in the Basic plan +", "Unlimited transactions", "Unlimited Edison AI agent", "Unlimited RPC calls", "Unlimited API calls", "Unlimited Webhook calls", "Individual support approach"]}
