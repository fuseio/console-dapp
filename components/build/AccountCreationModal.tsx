    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="bg-white min-h-[344px] w-[525px] max-w-[95%] z-50 absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 rounded-2xl p-5 items-center flex flex-col justify-center text-center gap-[51.3px]"
        >
