      ...
      <section className={cn("flex flex-col", classNames?.pricingSection)}>
        ...
        <article className={cn(
          ...
          <Plan
            ...
            features={["1M transactions", "Up to 1000 Edison AI prompts", "Unlimited RPC calls", "1M API calls", "1M Webhook calls", "Access to all services on Fuse", "Reliable and fast support"]}
          ...
          <Plan
            ...
            features={["Everything in the Basic plan +", "Unlimited transactions", "Unlimited Edison AI agent", "Unlimited API calls and Webhook calls", "Individual support approach"]}
